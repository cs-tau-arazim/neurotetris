...
if __name__ == '__main__':
    ...
    while True:
        ...
        for i in xrange(generation_size):
            App = tetris.TetrisApp(ai_players[i], unitTime, minimal_gui, minimal_ai, seed)
        ...
        if generation % 1 == 0:
            App = tetris.TetrisApp(ai_players[results.index(max(results))], unitTime, True, minimal_ai, seed)
            res1 = App.run()
            print res1
